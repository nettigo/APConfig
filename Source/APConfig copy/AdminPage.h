...
const char adminPage[] PROGMEM =
  ...
  "<input name='newssid' type='text' minlength='2' maxlength='16' placeholder='New SSID'>"
  "<input name='newpassword' id='password1' type='text' minlength='8' maxlength='16' placeholder='New Password'>"
  "<input id='password2' type='text' minlength='8' maxlength='16' placeholder='Confirm Password' onchange='checkValid()'>"
  "<input name='sensorID1' type='text' minlength='1' maxlength='25' placeholder='SenseBox ID'>"
